    ...
    def board(self, episodes, queue):
        ...
        board = {
            ...
            "departments": [
                ...
                {"id": "costume", "name": "ฝ่ายคอสตูมและความต่อเนื่อง", "lead": "Costume Director", "room": "ห้องคอสตูม",
                 "does": "กำหนดชุด AION ตามยุค สถานที่ อากาศ และบทบาท โดยชุดต้องช่วยเล่าเรื่อง ไม่แย่งความเด่นจากหัวข้อ", "evidence": "มี Costume Bible และกติกาชุดตามบริบทก่อนสร้างภาพ", "handoff": "ส่ง costume brief รายฉากให้ฝ่ายภาพและ Video QA", "state": "active"},
                ...
                {"id": "audio", "name": "ฝ่ายเสียงและประกอบ", "lead": "Audio Agent", "room": "ห้องเสียง",
                 "does": "จัดบรรยายและตรวจเวลาเสียงต้นฉบับกับ storyboard ก่อนประกอบภาพสุดท้าย", "evidence": f"{rendered} วิดีโอมีไฟล์พร้อมตรวจ", "handoff": "ส่งรายงานเวลาที่ผ่านให้ฝ่ายภาพและฝ่ายคุณภาพ", "state": "ready"},
                {"id": "quality", "name": "ฝ่ายคุณภาพ", "lead": "Quality Agent", "room": "ห้องตรวจและส่งออก",
                 "does": "ตรวจหลักฐาน คุณค่าต่อผู้ชม และความต่อเนื่องเสียง–ภาพก่อน/หลังประกอบไฟล์", "evidence": f"{ready} ตอนพร้อมให้ AION เผยแพร่", "handoff": "ส่งเฉพาะงานที่ผ่านไปฝ่ายเผยแพร่", "state": "waiting" if ready else "active"},
                ...
                {"id": "growth", "name": "ฝ่ายวิเคราะห์ผู้ชมและกลยุทธ์", "lead": "Audience Intelligence Lead", "room": "ศูนย์สังเกตการณ์",
                 "does": "วิเคราะห์ผลตอบรับจริง หาคำถามที่คนสนใจ เปรียบเทียบผลคอนเทนต์ และเสนอการทดลองที่วัดผลได้", "evidence": f"บันทึกเสียงตอบรับ {self._count('social_feedback')} รายการ", "handoff": "ส่ง insight และสมมติฐานให้ AION เลือกทิศทางถัดไป", "state": "active"},
                {"id": "audience-accessibility", "name": "ฝ่ายผู้ชมและการเข้าถึง", "lead": "Audience & Accessibility Lead", "room": "ศูนย์บัญชาการแพลตฟอร์ม",
                 "does": "อ่าน retention และคำถามผู้ชมเมื่อมีข้อมูลจริง พร้อมตรวจ caption track และจังหวะงานก่อนเผยแพร่", "evidence": "รายงานเฉพาะสัญญาณที่แพลตฟอร์มส่งกลับ ไม่เดาความนิยม", "handoff": "ส่งข้อค้นพบและข้อกำหนดการเข้าถึงให้ Story, Quality และ Publishing", "state": workflow_states.get("audience-accessibility", "unknown")},
            ...
            "agents": [
                ...
                {"name": "Costume Director", "department": "ฝ่ายคอสตูมและความต่อเนื่อง", "does": "เลือกชุดตามสถานที่ ฤดูกาล และภารกิจ พร้อมกันชุดแฟชั่นที่ดึงความสนใจจากเรื่อง", "handoff": "ส่ง costume brief ให้ Visual Director", "state": "active"},
                ...
                {"name": "Audio-Visual Continuity QA", "department": "ฝ่ายคุณภาพ", "does": "ตรวจเสียงต้นฉบับเทียบ storyboard ก่อน muxing และตรวจเวลาภาพ/คำบรรยายซ้ำก่อนเผยแพร่; งานที่ไม่พอดีถูกส่งกลับ ไม่ตัดเสียงทิ้ง", "handoff": "ส่งรายการแก้ให้ Story และ Visual หรือส่งงานผ่านให้ Video QA", "state": workflow_states.get("quality", "unknown")},
                ...
                {"name": "Audience Accessibility Reviewer", "department": "ฝ่ายผู้ชมและการเข้าถึง", "does": "แยกผลตอบรับจริงออกจากข้อสันนิษฐาน และเตือนเรื่อง caption track/จังหวะฉาก", "handoff": "ส่งเกณฑ์ที่ตรวจได้ให้ Quality Guardian", "state": workflow_states.get("audience-accessibility", "unknown")},
