...
class CompanyOperations:
    DEPARTMENTS = (
        ...
        ("audience-accessibility", ("brain/audience_accessibility.py", "brain/youtube_quality.py"),
         (".github/workflows/audience-accessibility.yml", ".github/workflows/youtube-creator.yml")),
