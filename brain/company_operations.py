...
class CompanyOperations:
    DEPARTMENTS = (
        ...
        ("visual", ("brain/visual_content.py", "brain/creator_scene_production.py", "tools/image_render.py"),
         (".github/workflows/creator-scene-production.yml", ".github/workflows/costume-briefs.yml")),
        ...
        ("engineering", ("brain/system_reliability.py", "brain/self_repair.py", "brain/company_quality_audit.py"),
         (".github/workflows/system-reliability.yml", ".github/workflows/self-repair.yml", ".github/workflows/tests.yml")),
