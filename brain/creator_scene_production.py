    ...
    def _style_rule(self, visual_style, deliberation=None):
        ...
        if style_id == "aion-neon-vector-shorts-v1":
            return (
                ...
                "still reserved only for AION's tiny glowing question-mark held in one hand, never a full body colour. No text, "
        ...
        if style_id == "aion-neon-graphic-science-v1":
            return (
                ...
                "glowing question-mark held in one hand. Where the mechanism itself is electrical, energetic, or signal-like, a "
