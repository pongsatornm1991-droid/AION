...
Instagram content is visual-first: AION keeps caption text in the platform
caption field and never places wording, watermarks, or a caption overlay inside
the artwork. If a future image service is unavailable, the cycle stops that
post rather than quietly recycling a prior image. A separate read-only feedback cycle captures changed follower,
