        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            for episode_id in ("legacy", "fresh"):
                episode = {"id": episode_id, "series": "AION Wonders", "title": episode_id,
                           ...
                           "wonder_hook": "Why can an octopus change colour in seconds?", "creative_device": "mystery-reveal", "age_layers": {"children": "Notice the colours.", "family": "Talk about camouflage.", "deeper": "Compare the evidence."},
                           "sources": [{"url": "https://one.test"}, {"url": "https://two.test"}], "uncertainty_boundary": "The sources do not answer every detail.", "scenes": [{"n": n, "visual": "AION observes the subject.", "narration": "clue"} for n in range(1, 13)]}
